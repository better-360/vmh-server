/*
  ...
  - The values [IN_PROCESS] on the enum `MailStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."MailStatus_new" AS ENUM ('PENDING', 'FORWARDED', 'SHREDDED', 'JUNKED', 'HOLDING_FOR_PICKUP', 'IN_PROGRESS', 'CONSOLIDATED', 'SCANNED', 'COMPLETED', 'WAITING_FOR_CONSOLIDATION', 'OTHER');
