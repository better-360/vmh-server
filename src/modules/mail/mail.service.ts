...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;">
  ...
  //OK
async sendCompanyFormationPaymentSuccessdMail(email: string, fullName: string,company_name) {
    await this.resendMailer.emails.send({
      from: 'Registate <help@m.registate.com>',
      to: [email],
      subject: 'Company Formation Payment Successfly',
      html: `<html lang="en">
    <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Congratulations! Your Company is Being Formed.</title>
    <style type="text/css">
        /* General Reset Styles */
        body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }
        table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; }
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;">
    ...
    <span class="preheader" style="display: none; font-size: 1px; color: #f4f4f4; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden;">
        Great news! We've started processing your U.S. company formation application.
    </span>
        ...
        <tr>
            <td align="center" style="background-color: #f4f4f4; padding: 20px 0;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden;" class="email-container">
                    ...
                    <tr>
                        <td align="left" style="padding: 20px 40px; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: #0F2028;" class="content-cell">
                            <h1 style="margin: 0 0 20px 0; font-size: 24px; font-weight: bold; color: #0F2028;">Congratulations! Your Company is Being Formed.</h1>
                            <p style="margin: 0 0 15px 0;">Hi ${fullName},</p>
                            <p style="margin: 0 0 15px 0;">Exciting news! We have received your application and the formation process for your new U.S. company, <strong style="color: #1540FF;">${company_name}</strong>, has officially begun.</p>
                            <p style="margin: 0 0 15px 0;">Our team is now working on filing the necessary documents with the state. We'll keep you updated on the progress every step of the way.</p>
                            <p style="margin: 0 0 25px 0;">You can track the status of your application and manage your services anytime by logging into your dashboard.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td align="center" style="padding: 0px 40px 30px 40px; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px; color: #555555;" class="content-cell">
                            <p style="margin: 0;">If you have any questions during the process, please don't hesitate to <a href="https://registate.com/" target="_blank" style="color: #1540FF; text-decoration: underline;">contact our support team</a>.</p>
                        </td>
                    </tr>
